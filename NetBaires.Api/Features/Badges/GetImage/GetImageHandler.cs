...
namespace NetBaires.Api.Features.Badges.GetImage
{
    ...
    public class GetImageHandler : IRequestHandler<GetIamgeCommand, Stream>
    {
        ...
        public async Task<Stream> Handle(GetIamgeCommand request, CancellationToken cancellationToken)
        {
